...
cp -rf ../openwrt_pkg_ma/packages/net/curl feeds/packages/net/curl
cp -rf ../openwrt_pkg_ma/packages/libs/nghttp3 package/libs/nghttp3
cp -rf ../openwrt_pkg_ma/packages/libs/ngtcp2 package/libs/ngtcp2
# fstool
